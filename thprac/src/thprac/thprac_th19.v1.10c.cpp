...
#define AddCard asm_call_rel<0xDEBA0, Thiscall>
    ...
    protected:
        ...
        virtual void OnContentUpdate() override {
            ...
            mStage();
            ImGui::Separator();
            ImGui::TextUnformatted(S(TH19_ADDITIONAL_CARDS));
            Gui::MultiComboSelect(mAdditionalCards, cards[Gui::LocaleGet()], elementsof(cards[0]), S(TH18_CARD_FORMAT));
        }
    };
